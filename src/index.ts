 ...
 *
 * **As a library**, it re-exports the wire contract and the two pure vocabularies both halves share,
 * so another package can type against the `worktree` namespace without depending on the Host
